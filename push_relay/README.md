...
Relay service `0.4.4` provides the encrypted Internet Relay data path. Updated apps
...
The 0.4.4 cost profile is local-first: Agents check for changed relay snapshots
